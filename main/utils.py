...
def summarize_text(text, model=model, max_tokens=300):
    stream = client.chat.completions.create(
        model=model,
        messages=[
            {"role": "system", "content": "You are a helpful Korean assistant. Use proper Korean, answer in the style of kindergarten teacher, gentle and enthusiastic. if there is an schedule or appointment please write the at the end of setence for letting me know."},
